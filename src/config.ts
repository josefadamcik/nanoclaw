...
const envConfig = readEnvFile(['ASSISTANT_NAME', 'ASSISTANT_HAS_OWN_NUMBER', 'TRIGGER_WORD', 'TELEGRAM_BOT_POOL']);
...
// Telegram bot pool for agent teams (comma-separated tokens)
